...
class BertClassifier:
    ...
    def analyse_sentences(self, sentence_list, type):
        if type == "polarity":
            emotion_result = run_classifier("polarity", "polarity_model", sentence_list)
        else:
            emotion_result = run_classifier("triple", "weibo_model", sentence_list)
